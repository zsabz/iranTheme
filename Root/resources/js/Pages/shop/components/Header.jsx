          ...
          <div className="container">
            <div className="header-left">
              <div className="header-dropdown">
                <a href="#">
                  <font style={{ verticalAlign: "inherit" }}>
                    <font style={{ verticalAlign: "inherit" }}>دلار آمریکا</font>
                  </font>
                </a>
                <div className="header-menu">
                  <ul>
                    <li>
                      <a href="#">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>یورو</font>
                        </font>
                      </a>
                    </li>
                    <li>
              ...
              <div className="header-dropdown">
                <a href="#">
                  <font style={{ verticalAlign: "inherit" }}>
                    <font style={{ verticalAlign: "inherit" }}>مهندس</font>
                  </font>
                </a>
                <div className="header-menu">
                  <ul>
                    <li>
                      <a href="#">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>انگلیسی</font>
                        </font>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>فرانسوی</font>
                        </font>
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>اسپانیایی</font>
                        </font>
                      </a>
                    </li>
                  </ul>
            ...
            <div className="header-right">
              <ul className="top-menu">
                <li>
                  <a href="#">
                    <font style={{ verticalAlign: "inherit" }}>
                      <font style={{ verticalAlign: "inherit" }}>پیوندها</font>
                    </font>
                  </a>
                  <ul>
                    <li>
                    ...
                    <li>
                      <a href="about.html">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>درباره ما</font>
                        </font>
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#signin-modal" data-toggle="modal">
                        ...
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>وارد شدن</font>
                        </font>
                      </a>
                    </li>
                  </ul>
                  ...
                  >
                    <li className="megamenu-container active">
                      <a href="index.html" className="sf-with-ul">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>صفحه اصلی</font>
                        </font>
                      </a>
                      <div className="megamenu demo" style={{ display: "none" }}>
                    ...
                    <li>
                      <a href="category.html" className="sf-with-ul">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>خرید کنید</font>
                        </font>
                      </a>
                      <div
                    ...
                    <li>
                      <a href="#" className="sf-with-ul">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>صفحات</font>
                        </font>
                      </a>
                    ...
                    <li>
                      <a href="blog.html" className="sf-with-ul">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>وبلاگ</font>
                        </font>
                      </a>
                      <ul style={{ display: "none" }}>
                        <li>
                    ...
                    <li>
                      <a href="elements-list.html" className="sf-with-ul">
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>عناصر</font>
                        </font>
                      </a>
                      <ul style={{ display: "none" }}>
                        <li>
                  ...
                  <div className="dropdown-menu dropdown-menu-right">
                    <ul className="compare-products">
                      <li className="compare-product">
                        <a href="#" className="btn-remove" title="محصول را حذف کنید">
                ...
                <div className="dropdown cart-dropdown">
                  ...
                  <div className="dropdown-menu dropdown-menu-right">
                    ...
                    <div className="dropdown-cart-total">
                      <span>
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>جمع</font>
                        </font>
                      </span>
                    ...
                    <div className="dropdown-cart-action">
                      ...
                      <a href="checkout.html" className="btn btn-outline-primary-2">
                        <span>
                          <font style={{ verticalAlign: "inherit" }}>
                            <font style={{ verticalAlign: "inherit" }}>وارسی</font>
                          </font>
                        </span>
                        <i className="icon-long-arrow-right" />
                      </a>
